Paradigma – classificação de uma linguagem de programação baseado nas funcionalidades, e na visão que se deve ter sobre a estrutura e a execução do programa. Algumas delas suportam vários paradigmas.
